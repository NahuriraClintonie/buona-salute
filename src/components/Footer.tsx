      ...
      <div className="container-max py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <img src={logo} alt="Salusperes Initiatives" className="h-12 w-auto rounded" />
              <div>
                <p className="font-bold text-background">Salusperes</p>
                <p className="text-sm text-background/70">Initiatives</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-background/70">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>info@salusperes.org</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="material-icons-outlined text-brand-gold text-lg">phone</span>
                <div className="flex flex-col">
                  <a href="tel:+256772333412" className="hover:text-brand-gold transition-colors">+256 782 196 628</a>
                  <a href="tel:+256782196628" className="hover:text-brand-gold transition-colors">+256 773 252 651</a>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-background/10 text-center">
          <p className="text-sm text-background/50">
            © {new Date().getFullYear()} Salusperes Initiatives. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
